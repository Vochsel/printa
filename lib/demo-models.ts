...
export const DEMO_MODELS = {
  ...
  "voronoi-shell-lamp": {
    version: "1.0",
    name: "Blobby Voronoi lantern",
    description: "Surface-scattered Voronoi boundaries polywired and volumetrically remeshed into one smooth light shell.",
    units: "mm",
    root: {
      kind: "shape",
      id: "voronoi-lantern",
      source: { type: "primitive", shape: "sphere", width: 82, depth: 82, height: 88, radius: 41, segments: 64 },
      modifiers: [{ type: "voronoi", amplitude: 2.2, scale: 17, seed: 31, mode: "wire", contrast: 1.35 }],
      material: "resin",
    },
    print: printDefaults,
    metadata: { family: "lampshade", pattern: "voronoi-wire" },
  },
