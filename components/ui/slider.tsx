    ...
    >
      ...
      {Array.from({ length: _values.length }, (_, index) => (
        <SliderPrimitive.Thumb
          ...
          key={index}
          className="block size-3.5 shrink-0 rounded-full border-2 border-accent bg-background shadow-sm transition-[color,box-shadow] outline-none cursor-grab active:cursor-grabbing hover:ring-4 hover:ring-ring/30 focus-visible:ring-4 focus-visible:ring-ring/40 disabled:pointer-events-none"
        />
      ))}
    </SliderPrimitive.Root>
  );
