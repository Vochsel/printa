...
function ResizableHandle({
  ...
  return (
    <ResizablePrimitive.PanelResizeHandle
      ...
      className={cn(
        "relative flex w-px items-center justify-center bg-border transition-colors after:absolute after:inset-y-0 after:left-1/2 after:w-2 after:-translate-x-1/2 hover:bg-ring data-[resize-handle-state=drag]:bg-ring focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:outline-none",
    ...
    >
      {withHandle && (
        <div className="z-10 flex h-5 w-3.5 items-center justify-center rounded-sm border border-border bg-secondary">
